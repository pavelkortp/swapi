...
export class AddVehicles1704838935393 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "vehicles" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "name" character varying NOT NULL, "model" character varying NOT NULL, "manufacturer" character varying NOT NULL, "cost_in_credits" character varying NOT NULL, "length" character varying NOT NULL, "max_atmosphering_speed" character varying NOT NULL, "crew" character varying NOT NULL, "passengers" character varying NOT NULL, "cargo_capacity" character varying NOT NULL, "consumables" character varying NOT NULL, "vehicle_class" character varying NOT NULL, "created" TIMESTAMP NOT NULL DEFAULT now(), "edited" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_aa397b791341ed3615397050d4b" UNIQUE ("name"), CONSTRAINT "PK_18d8646b59304dce4af3a9e35b6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "vehicles_people" ("vehiclesId" integer NOT NULL, "peopleId" integer NOT NULL, CONSTRAINT "PK_d0a15ed79be70bf69c1dcf344fa" PRIMARY KEY ("vehiclesId", "peopleId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_50a5438d9a92e490f0a7277206" ON "vehicles_people" ("vehiclesId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_dddb9d7b6f97f1c21e8df59fe5" ON "vehicles_people" ("peopleId") `,
    );
    await queryRunner.query(
      `CREATE TABLE "vehicles_films" ("vehiclesId" integer NOT NULL, "filmsId" integer NOT NULL, CONSTRAINT "PK_180e500f7dd42c18d058f56a426" PRIMARY KEY ("vehiclesId", "filmsId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_c357b000f6771bf8bc35ef2ed5" ON "vehicles_films" ("vehiclesId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_de82f01b798a6cef935912973b" ON "vehicles_films" ("filmsId") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_de82f01b798a6cef935912973b"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c357b000f6771bf8bc35ef2ed5"`,
    );
    await queryRunner.query(`DROP TABLE "vehicles_films"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_dddb9d7b6f97f1c21e8df59fe5"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_50a5438d9a92e490f0a7277206"`,
    );
