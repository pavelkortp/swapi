...
export class ChangePlanetsTypes21714570099132 implements MigrationInterface {
  name = 'ChangePlanetsTypes21714570099132';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "planets" DROP COLUMN "diameter"`);
    await queryRunner.query(
      `ALTER TABLE "planets" ADD "diameter" character varying NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "planets" DROP COLUMN "diameter"`);
    await queryRunner.query(
      `ALTER TABLE "planets" ADD "diameter" integer NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "species_films" ADD CONSTRAINT "FK_80755b97f28bfae4f163d389609" FOREIGN KEY ("speciesId") REFERENCES "species"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
