...
export class ChangePlanetsSurfaceWaterType1714569509755
  implements MigrationInterface
{
  name = 'ChangePlanetsSurfaceWaterType1714569509755';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "planets" DROP COLUMN "surface_water"`,
    );
    await queryRunner.query(
      `ALTER TABLE "planets" ADD "surface_water" character varying NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "planets" ADD "surface_water" integer NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "species_films" ADD CONSTRAINT "FK_80755b97f28bfae4f163d389609" FOREIGN KEY ("speciesId") REFERENCES "species"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
