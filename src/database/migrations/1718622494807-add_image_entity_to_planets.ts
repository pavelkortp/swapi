...
export class AddImageEntityToPlanets1718622494807
  implements MigrationInterface
{
  name = 'AddImageEntityToPlanets1718622494807';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "planets_images" ("planetsId" integer NOT NULL, "imageId" integer NOT NULL, CONSTRAINT "PK_8e4ce5065cf1293008c128d5ded" PRIMARY KEY ("planetsId", "imageId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_6ff97d1d06875977f896e8933b" ON "planets_images" ("planetsId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_08f0f34e587db540ae413b3549" ON "planets_images" ("imageId") `,
    );
    await queryRunner.query(
      `ALTER TABLE "planets_images" ADD CONSTRAINT "FK_6ff97d1d06875977f896e8933b0" FOREIGN KEY ("planetsId") REFERENCES "planets"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "planets_images" ADD CONSTRAINT "FK_08f0f34e587db540ae413b35493" FOREIGN KEY ("imageId") REFERENCES "image"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "planets_images" DROP CONSTRAINT "FK_08f0f34e587db540ae413b35493"`,
    );
    await queryRunner.query(
      `ALTER TABLE "planets_images" DROP CONSTRAINT "FK_6ff97d1d06875977f896e8933b0"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_08f0f34e587db540ae413b3549"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_6ff97d1d06875977f896e8933b"`,
    );
