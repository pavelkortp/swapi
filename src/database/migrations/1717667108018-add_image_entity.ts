...
export class AddImageEntity1717667108018 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "image" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "link" character varying NOT NULL, CONSTRAINT "PK_d6db1ab4ee9ad9dbe86c64e4cc3" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "people_images" ("peopleId" integer NOT NULL, "imageId" integer NOT NULL, CONSTRAINT "PK_8050841567e2dab009e3d2ad436" PRIMARY KEY ("peopleId", "imageId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_b77fd6b6f01dc7456a9cb9f097" ON "people_images" ("peopleId") `);
        await queryRunner.query(`CREATE INDEX "IDX_b0160916c647c7937e03ef9d39" ON "people_images" ("imageId") `);
        ...
        await queryRunner.query(`ALTER TABLE "people_images" ADD CONSTRAINT "FK_b0160916c647c7937e03ef9d39b" FOREIGN KEY ("imageId") REFERENCES "image"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "people_images" DROP CONSTRAINT "FK_b0160916c647c7937e03ef9d39b"`);
        await queryRunner.query(`ALTER TABLE "people_images" DROP CONSTRAINT "FK_b77fd6b6f01dc7456a9cb9f097d"`);
        await queryRunner.query(`ALTER TABLE "people_films" DROP CONSTRAINT "FK_a6ae8e23d835bdbc6b9fe43823f"`);
        await queryRunner.query(`ALTER TABLE "people_films" DROP CONSTRAINT "FK_f9d0038e205e511024d88b4c441"`);
        await queryRunner.query(`ALTER TABLE "vehicles_films" DROP CONSTRAINT "FK_de82f01b798a6cef935912973bf"`);
        await queryRunner.query(`ALTER TABLE "vehicles_films" DROP CONSTRAINT "FK_c357b000f6771bf8bc35ef2ed55"`);
        ...
        await queryRunner.query(`ALTER TABLE "planets_films" DROP CONSTRAINT "FK_d7f4d68dc596fce125db571c771"`);
        await queryRunner.query(`ALTER TABLE "planets_films" DROP CONSTRAINT "FK_1b9e498a7b6714398614766c245"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b0160916c647c7937e03ef9d39"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b77fd6b6f01dc7456a9cb9f097"`);
