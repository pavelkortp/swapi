...
export class ChangeSpeciesLifespanToString1719231894775
  implements MigrationInterface
{
  name = 'ChangeSpeciesLifespanToString1719231894775';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "species" DROP COLUMN "average_lifespan"`,
    );
    await queryRunner.query(
      `ALTER TABLE "species" ADD "average_lifespan" character varying NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "species" ADD "average_lifespan" integer NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "species_films" ADD CONSTRAINT "FK_80755b97f28bfae4f163d389609" FOREIGN KEY ("speciesId") REFERENCES "species"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
