...
export class ChangePlanetsTypes1714569858284 implements MigrationInterface {
  name = 'ChangePlanetsTypes1714569858284';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "planets" DROP COLUMN "rotation_period"`,
    );
    await queryRunner.query(
      `ALTER TABLE "planets" ADD "rotation_period" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "planets" DROP COLUMN "orbital_period"`,
    );
    await queryRunner.query(
      `ALTER TABLE "planets" ADD "orbital_period" character varying NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "planets" ADD "orbital_period" integer NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "planets" DROP COLUMN "rotation_period"`,
    );
    await queryRunner.query(
      `ALTER TABLE "planets" ADD "rotation_period" integer NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "species_films" ADD CONSTRAINT "FK_80755b97f28bfae4f163d389609" FOREIGN KEY ("speciesId") REFERENCES "species"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
