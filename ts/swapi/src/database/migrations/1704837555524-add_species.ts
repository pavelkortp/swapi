...
export class AddSpecies1704837555524 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "species" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "name" character varying NOT NULL, "classification" character varying NOT NULL, "designation" character varying NOT NULL, "average_height" character varying NOT NULL, "skin_colors" character varying NOT NULL, "hair_colors" character varying NOT NULL, "eye_colors" character varying NOT NULL, "average_lifespan" integer NOT NULL, "language" character varying NOT NULL, "created" TIMESTAMP NOT NULL DEFAULT now(), "edited" TIMESTAMP NOT NULL DEFAULT now(), "homeworldId" integer, CONSTRAINT "PK_ae6a87f2423ba6c25dc43c32770" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "species_people" ("speciesId" integer NOT NULL, "peopleId" integer NOT NULL, CONSTRAINT "PK_3746d2b49376d40e2b65ca845cd" PRIMARY KEY ("speciesId", "peopleId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_3fcb52d51b8b93c9707ac164d8" ON "species_people" ("speciesId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_8019a9b0a4e75b66f02bc76a7c" ON "species_people" ("peopleId") `,
    );
    await queryRunner.query(
      `CREATE TABLE "species_films" ("speciesId" integer NOT NULL, "filmsId" integer NOT NULL, CONSTRAINT "PK_61891ef4f6e91b846b60d7f7be0" PRIMARY KEY ("speciesId", "filmsId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_80755b97f28bfae4f163d38960" ON "species_films" ("speciesId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_c39d2aecfd9c301a9cd5bc3aef" ON "species_films" ("filmsId") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c39d2aecfd9c301a9cd5bc3aef"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_80755b97f28bfae4f163d38960"`,
    );
    await queryRunner.query(`DROP TABLE "species_films"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_8019a9b0a4e75b66f02bc76a7c"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_3fcb52d51b8b93c9707ac164d8"`,
    );
